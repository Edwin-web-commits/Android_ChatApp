...
// For sending notification on your mobile device

public class OreoNotification extends ContextWrapper {

    private static final String CHANNEL_ID="com.example.goChat";
    private static final String CHANNEL_NAME="GoChat";
